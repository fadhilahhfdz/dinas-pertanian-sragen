                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <div class="card-header-form">
                                        <a href="/admin/informasi-publik/create" class="btn btn-sm btn-primary"><i
                                    ...
                                    <tbody>
                                        @foreach ($informasiPublik as $item)
                                            <tr>
                                                ...
                                                <td>{!! $item->konten !!}</td>
                                                <td>
                                                    <a href="/admin/informasi-publik/edit/{{ $item->id }}"
                                                        class="btn btn-sm btn-warning text-white"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="/admin/informasi-publik/delete/{{ $item->id }}"
