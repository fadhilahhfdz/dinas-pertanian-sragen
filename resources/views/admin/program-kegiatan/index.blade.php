                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <div class="card-header-form">
                                        <a href="/admin/program-kegiatan/create" class="btn btn-sm btn-primary"><i
                                    ...
                                    <tbody>
                                        @foreach ($programKegiatan as $item)
                                            <tr>
                                                ...
                                                <td>{!! $item->konten !!}</td>
                                                <td>
                                                    <a href="/admin/program-kegiatan/edit/{{ $item->id }}"
                                                        class="btn btn-sm btn-warning text-white"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="/admin/program-kegiatan/delete/{{ $item->id }}"
