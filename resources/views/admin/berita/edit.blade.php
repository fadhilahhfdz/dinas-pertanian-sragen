                                ...
                                <form action="/admin/berita/edit/{{ $berita->id }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" id="author" name="author" class="form-control" value="{{ $berita->author }}" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="konten" class="form-control" id="summernote" required>{{ $berita->konten}}</textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
